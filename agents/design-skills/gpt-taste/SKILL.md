...
when_to_use: "Use when building expressive editorial/marketing web pages with GSAP-heavy motion and high layout variance (Codex/GPT-tuned variant of the taste skill). Web/CSS surfaces only."
---
