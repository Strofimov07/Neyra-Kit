...
when_to_use: >-
  Use when reviewing web animation/motion code before it ships — CSS/JS transitions,
  keyframes, spring configs, easing curves, durations. Invoke explicitly as part of
  the UI review pass; it flags by default and approval is earned.
