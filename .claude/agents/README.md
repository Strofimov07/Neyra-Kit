# Subagents (canonical portable set)
...
| [contract-doc-sync](contract-doc-sync.md) | Keeps contract-layer documentation and registries synchronized with contract changes. |
...
| [design-system-conformance](design-system-conformance.md) | Reviews UI diffs for reuse of existing components, tokens, states, and interaction patterns. |
...
| [incident-runbook](incident-runbook.md) | Diagnoses and contains known production incidents from per-project failure modes. |
...
| [pr-hygiene](pr-hygiene.md) | Enforces branch, staging, commit, push, and PR mechanics. |
...
| [skill-capture](skill-capture.md) | Captures a repeated workflow as a reusable canonical skill. |
