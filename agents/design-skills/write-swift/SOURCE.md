...
- **Upstream:** [emilkowalski/skill](https://github.com/emilkowalski/skill) — `skills/write-swift/SKILL.md`
...
via `hooks/session-start.sh`. The one **iOS-side** bundled skill: Swift language craft for `ios/**`; it does not emit UI and defers screen design to `swiftui-design-principles`.
