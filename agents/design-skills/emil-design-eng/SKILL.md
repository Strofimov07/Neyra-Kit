...
when_to_use: >-
  Use when building or refining web/React UI polish, component design, or motion —
  spacing, states, transitions, hover/press feedback, and the small details that
  make an interface feel crafted. Web/CSS surfaces (aso/frontend-web, ops-console,
  landing pages), not SwiftUI code.
---
