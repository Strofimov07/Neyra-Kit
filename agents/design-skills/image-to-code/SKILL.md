...
when_to_use: "Use when a visually important web UI should first be designed as an image, analyzed, then implemented from that reference in code. Web surfaces."
---
