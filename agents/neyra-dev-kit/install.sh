...
render() { # render <template-file> -> stdout. Values passed via env (no code injection),
  ...
  perl -0777 -pe '
    for my $k (qw(REPO_NAME STACK BUILD_VERIFY_CMD LOCALES I18N_MECHANISM CONTRACT_STACK LINEAR_WORKSPACE LINEAR_ROUTING LINEAR_LABELS NEYRA_MCP_ENTRY LINEAR_MCP_PREFIX FIREBASE_MCP_DIR FIREBASE_MCP_SCOPE_FLAG FIREBASE_MCP_SCOPE)) {
