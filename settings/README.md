...
| `settings/lessons.md` | this project's promoted lessons (seeded once by `install.sh`, then repo-owned — the kit never rewrites it). Read every session | kit-evolution, every session via KIT_BOOTSTRAP |
