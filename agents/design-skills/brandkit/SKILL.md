...
when_to_use: "Use when generating brand-guideline boards, logo systems, identity decks, or visual-world reference imagery for a web/product brand. Image-generation design aid."
---
