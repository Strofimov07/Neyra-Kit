...
when_to_use: >-
  Use when building or reviewing gesture-driven or spring-based web UI — drag/swipe/sheet
  interactions, momentum and interruptible transitions, translucent materials, depth,
  optical typography, reduced-motion. Web/CSS surfaces only; for native Apple UI use
  `swiftui-design-principles` and `apple-hig`.
---
